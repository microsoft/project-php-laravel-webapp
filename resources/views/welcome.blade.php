...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        @font-face{
            ...
            src: url('../resources/assets/fonts/segoeuil.ttf');
        }
        .main-container {
            height: 100%;
            width: 100%;
    ...
    <body>
        ...
        <div class="cloud-image">
            <img src="../resources/assets/img/successCloudNew.svg" />
        </div>
        <div class="content">
            ...
            <a href="http://twitter.com/intent/tweet/?text=I%20just%20created%20a%20new%20PHP%20Laravel%20website%20on%20Azure%20using%20Azure%20DevOps%20Project&hashtags=AzureDevOpsProject%2CVSTS%20%40Azure%20%40VSTS">
                <img src="../resources/assets/img/tweetThis.svg" />
            </a>            
        </div>
            <div class="content-body">
                ...
                <div class="next-steps-container">
                    ...
                    <div class="next-steps-body">
                        <div class="step">
                            <div class="step-icon">
                                <img src="../resources/assets/img/cloneWhite.svg">
                            </div>
                        ...
                        <div class="step">
                            <div class="step-icon">
                                <img src="../resources/assets/img/deployWhite.svg">
                            </div>
